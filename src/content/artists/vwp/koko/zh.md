...
debutDate: "2020-10-25"
profileTagline: "以摇滚式长音与正面冲击力为标识的虚拟摇滚歌手。"
designCredits:
  - "角色设计：SWAV"
affiliations:
  - "KAMITSUBAKI STUDIO"
...
officialLinks:
  - label: "KAMITSUBAKI 官方艺人页"
    href: "https://kamitsubaki.jp/artist/koko/"
  - label: "V.W.P 官方页"
...
featuredEntries:
  ...
  - label: "神椿市建设中。"
    ...
    kind: "project"
theme:
  name: "KOKO Lightning Rock"
  accentColor: "#8a5cff"
  mutedColor: "#5c79ff"
  surfaceColor: "#0b0b12"
  highlightColor: "#f2f0ff"
  palette:
    - label: "电光紫"
      value: "#8A5CFF"
    - label: "冷蓝"
...
官方介绍中，幸祜被形容为能够像闪电一样拉出长音的虚拟歌手，这种形容相当贴近她的听感形象。她的声音常给人一种笔直、强穿透、少回避的印象，因此无论放在个人曲、V.W.P 派生曲还是现场舞台上，都很容易形成明确存在感。

在 V.W.P 内部，幸祜往往承担更偏“正面突破”的声场位置，也因此在与其他成员组合时经常能形成鲜明的互补关系。

## 基本资料与人物设定

“幸祜”的“祜”有福、护佑之意，名称本身带有祝福意味。角色由 SWAV 设计，初始形象以黑色至紫蓝色渐变的长发、紫色瞳孔、耳环、颈部装饰和机能风夹克为特征；她的舞台形态会根据个人 Live 的概念发生明显变化。

| 项目 | 内容 |
| --- | --- |
| 角色设计 | SWAV |
| 初次公开活动 | 2020年10月25日发布介绍视频与《Hearts》翻唱 |
...
- **9月3日**：举办 2nd ONE-MAN LIVE「PLAYER II -神椿市肆番街-」（线上）。
...
| 作品阶段 | 主要内容 | 说明 |
| --- | --- | --- |
| 早期原创 | 《harmony》《白昼夢》《この世界に口づけを》 | 建立直线型、强穿透的歌声形象 |
