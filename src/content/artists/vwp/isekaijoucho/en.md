...
profileTagline: "A virtual dark singer whose work is built around shadowed imagination, self-authored expression, and strong narrative atmosphere."
affiliations:
  - "KAMITSUBAKI STUDIO"
  - "V.W.P"
  - "PHENOMENON RECORD"
officialLinks:
  - label: "KAMITSUBAKI official artist page"
    href: "https://kamitsubaki.jp/artist/isekaijoucho/"
  - label: "Official V.W.P page"
...
featuredEntries:
  ...
  - label: "SEKAI"
    ...
    kind: "artist"
  - label: "Kamitsubaki City Under Construction"
    href: "/en/projects/arg/kamitsubaki-city"
    kind: "project"
theme:
  ...
  palette:
    - label: "Otherworld Orange"
      value: "#D65A31"
    - label: "Dark Green Gray"
      value: "#7F8F78"
    - label: "Ink Black"
      value: "#0D1110"
    - label: "Pale Light"
...
- **December 9**: Uploaded her first teaser video and announced the start of her activities.
- **December 12**: Released her first cover song, "Yogao no Kokaku" (夜顔の告白).
...
- **January 14**: Held her second cover live, "Candy Live 2" (キャンディライブ2).
- **June 18**: Held her 2nd ONE-MAN LIVE "Anima II -Kamitsubaki City 3rd Avenue-" and unveiled her new 3D model "Fuben-tai" (普遍体).
- **December 9**: Announced the production of her 2nd album, *Shikisai* (色彩), during her 4th anniversary livestream.

### 2024

- **March 27**: Released her 2nd album, *Shikisai* (色彩).
- **August 7**: Held her first physical solo concert (3rd ONE-MAN LIVE) "Anima III" at Pacifico Yokohama National Convention Hall.
- **August 13–15**: Performed as a member of V.W.P in the debut of KAMITSUBAKI STUDIO's growing virtual stage play *Otogibanashi (Sen)*.

### 2025

- **February – March**: Held her second solo art exhibition, "ISEKAIJOUCHO Exhibition II" (ヰ世界情緒展Ⅱ), in Tokyo and Osaka.
- **September 25 – October 26**: Held her first overseas exhibition, the "ISEKAIJOUCHO Exhibition" Shanghai Special Exhibition.

### 2026

- **February 25**: Released her 1st E.P., *Genshiroku* (幻視録).
