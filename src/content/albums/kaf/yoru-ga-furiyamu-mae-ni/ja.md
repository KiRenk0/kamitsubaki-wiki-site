...
artist: 花譜
type: "EP"
description: "映画『ホットギミック ガールミーツボーイ』主題歌を軸に、原曲・2種のリミックス・インストを収録したEP。"
...
映画『ホットギミック ガールミーツボーイ』主題歌を軸に、原曲・2種のリミックス・インストを収録したEP。
...
全4トラック。上部のトラック表にはディスク番号、曲順、再生時間、共演者、サイト内楽曲リンクを収録しています。
