...
「daydream ([Guiano](/ja/artists/creators/guiano) Remix)」は『[GLITCH STAGE](/ja/albums/harusaruhi/glitch-stage)』または関連する正式リリースに収録です。このページは録音バージョン単位で作成し、ライブ、リミックス、リアレンジ版を原曲と区別しています。
