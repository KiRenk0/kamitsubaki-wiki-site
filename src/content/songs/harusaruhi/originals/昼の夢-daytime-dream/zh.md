...
《昼の夢》收录于《SPICE OF LIFE》或其相关正式发行。本词条按具体录音版本建立；现场、重混与重新编曲版不会与原版混为一项。
...
<div class="cn-lyric">午后柔和的阳光</div>
</div>
...
<div class="cn-lyric">身体暖洋洋像摇篮曲</div>
</div>
...
<div class="cn-lyric">摇曳的窗帘上睫毛也轻轻晃动</div>
</div>
...
<div class="cn-lyric">不知不觉在梦中呼呼大睡</div>
</div>
...
<div class="cn-lyric">这份幸福 从早晨再睡回笼觉</div>
</div>
...
<div class="cn-lyric">已经是午睡 不管不顾了呢</div>
</div>
...
<div class="cn-lyric">等会儿吃蛋糕和咖啡</div>
</div>
...
<div class="cn-lyric">苦的不行 牛奶要加足</div>
</div>
...
<div class="cn-lyric">无所事事的daytime</div>
</div>
...
<div class="cn-lyric">梦里happy day</div>
</div>
...
<div class="cn-lyric">也不焦虑的daytime</div>
</div>
...
<div class="cn-lyric">这样的日子good day</div>
</div>
