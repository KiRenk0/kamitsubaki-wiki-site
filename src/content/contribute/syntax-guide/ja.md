...
左のプロパティで記事情報、右のプレビューとブロック設定で表示を確認します。Markdown 全体を出力して GitHub で差分を確認し、PR を作ります。下書きはこのブラウザー内に保存され、画像は別途アップロードが必要です。複雑な内容は保持され、必要な部分は本ページを参照してソースで編集できます。
...
```md
編集：src/content/artists/vwp/kaf/zh.md
