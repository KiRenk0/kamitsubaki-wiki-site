...
test('ordinary pages reveal immediately while preserving the first homepage intro', async () => {
  ...
  assert.match(interactions, /transitionDelay = 0/);
  ...
  assert.match(styles, /opacity 180ms ease-out/);
